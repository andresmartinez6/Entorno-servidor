<?php
    ...
    class modelo_videoclub{
        ...
        public function Insertar_series($nombre, $descripcion,$foto,$activo){
            $sentencia_insertarSeries = "INSERT INTO socios (id,nombre, descripcion,foto,activo) VALUES (?, ?, ?, ? ,?)";
        ...
        public function Buscar_plataforma($nombre) {
            ...
            $nombreBusqueda = "%{$nombre}%"; // Añadir comodines para la búsqueda por nombre parcial
            $consulta->bind_param("s", $nombreBusqueda);
            $consulta->execute();
